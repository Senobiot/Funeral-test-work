...
export const MenuIconButton: React.FC<IconButtonProps> = ({
  src = '',
  text,
  iconW = 20,
  iconH,
...
export const RegularIconButton: React.FC<RegularIconButtonProps> = ({
  ...
  return (
    <Button
      ...
      startIcon={
        !noIcon && <img src={src} alt='icon' width={iconW} height={iconH} />
      }
    >
      <Box
        sx={{
...
type OutlinedCardActionButtonProps = {
  image: string
  text: string
}

export const OutlinedCardActionButton: React.FC<
  OutlinedCardActionButtonProps
> = ({ image, text }) => (
  <OutlinedIconButton
    src={image}
    text={text}
